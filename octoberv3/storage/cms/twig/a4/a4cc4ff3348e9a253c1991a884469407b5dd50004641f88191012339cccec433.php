...
\t<!-- Part 1 of AOE -->
\t<!-- Below is the form inputs that will be listed for the customer to select, the information will be posted to the PHP file. To post this it uses a data-request and the name o fthe function.-->
