...

{
	...
	{
		// Stored in variables from the default.htm file.
		...
		// Inserted into the databse table profesiona_executor using the variables assisgned.
        ...
        // Directs the user to the legacies form.
